        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-heading mb-6">
              O propósito que nos{" "}
              <span className="text-steel">move todos os dias</span>
            </h2>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-steel/10 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto relative">
              {/* Background circles */}
              <div className="absolute inset-0 rounded-full bg-metal/5 animate-pulse" />
              <div className="absolute inset-8 rounded-full bg-steel/10" />
              <div className="absolute inset-16 rounded-full bg-metal/15" />
              
              {/* Center icon */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 rounded-full bg-metal flex items-center justify-center shadow-glow">
